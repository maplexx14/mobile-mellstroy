...
class WebPlatform {
    ...
    static assetWidth = resolution.UI_ASSET_WIDTH ?? resolution.UI_WIDTH;
    static resolutionBaseUrl = `images/${WebPlatform.assetWidth}/`;
    static uiImageBaseUrl = `images/${WebPlatform.assetWidth}/ui/`;
    static boxImageBaseUrl = `images/${WebPlatform.assetWidth}/${edition.boxDirectory || "ui/"}`;
    ...
    static getDrawingBaseUrl() {
        ...
        return `${baseUrl}/images/${WebPlatform.assetWidth}/ui/`;
    }
