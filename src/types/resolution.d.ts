...
export interface ResolutionProfile {
    ...
    /**
     * Folder under public/images/ to load UI/game sprites from. Defaults to UI_WIDTH
     * when absent. Lets a portrait profile reuse an existing landscape asset set
     * (e.g. images/1920) instead of shipping a duplicate folder.
     */
    UI_ASSET_WIDTH?: number;

    /**
     * Extra body class for CSS scoping (e.g. "ui-portrait"). The base `ui-${UI_WIDTH}`
     * class is always added; this is added in addition when present.
     */
    cssClass?: string;
